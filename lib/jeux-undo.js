(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("JeuxUndo", [], factory);
	else if(typeof exports === 'object')
		exports["JeuxUndo"] = factory();
	else
		root["JeuxUndo"] = factory();
})(window, function() {
...
function History() {
  ...
  var push = arrayProto.push.bind(past);
  var unshift = arrayProto.unshift.bind(future);
  var spliceCount = 1;

  function undoOrRedo(doRedo) {
    var array = doRedo ? future : past;
    var add = doRedo ? push : unshift;

    if (array.length > 0) {
      var spliceIndex = doRedo ? 0 : array.length - 1;
      var oldPresent = present;
      var newPresent = array.splice(spliceIndex, spliceCount);
...
//# sourceMappingURL=jeux-undo.js.map