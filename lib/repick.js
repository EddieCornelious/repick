(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Repick", [], factory);
	else if(typeof exports === 'object')
		exports["Repick"] = factory();
	else
		root["Repick"] = factory();
})(window, function() {
...
function createSelector(selectors, transform) {
  var cache = [];
  var oldTransformVal;
  return function (state, ownProps) {
    ...
    if (oldTransformVal === undefined) {
      cache = selectors.map(function (e) {
        return e(state, ownProps);
      });
      shouldTransform = true;
    } // check if anything changed


    var newVals = selectors.map(function (e) {
      return e(state, ownProps);
    });
...
//# sourceMappingURL=repick.js.map